	...
	render() {
		...
		if (this.state.calendar){
			if (this.state.daycare){
                panel = <Grid updateScreen={this.props.updateScreen} print={this.props.print} current={current} payment={this.props.payment} adminSetting={this.props.adminSetting}/>
			}
			else
