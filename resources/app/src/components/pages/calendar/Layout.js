    ...
    render() {
        ...
        return (
            <div>
                ...
                <GridLayout.Responsive layout={x} className="layout" onDragStop={this.onDragStop.bind(this)} preventCollision={true} rowHeight={22} width={1440} isResizable={false} compactType={null}>
                    {
                        current.map(obj =>
