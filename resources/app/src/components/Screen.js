...
export default class Screen extends React.Component {
	...
	render() {
		...
		if(this.state.screen === "print")
            ...
            return (<Payment kennel_map={this.props.kennel_map} updateScreen={this.props.updateScreen} booking={this.props.booking} extraServices={this.props.extraServices} adminSetting={this.props.adminSetting}/>)
            ...
            return (<Booking kennel_map={this.props.kennel_map} updateScreen={this.props.updateScreen} id_object={this.props.id_object} animal={this.props.animal} bookings={this.props.bookings} adminSetting={this.props.adminSetting}/>)
