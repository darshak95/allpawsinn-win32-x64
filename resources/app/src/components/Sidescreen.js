		...
		if (this.state.search){
			return(
				<div className= 'sideWrapper'>
					...
					<AnimalDetails updateScreen={this.props.updateScreen} daycare = {this.props.daycare} client = {this.props.client} profile = {this.props.profile} proc = {this.props.proc} dogs = {this.state.dogs} animal = {this.state.animal}/>
				</div>
			);
		}
		else{
